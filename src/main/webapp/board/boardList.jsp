...
<%
	// jsp에서 자바코드(스클립틀릿)와 html코드의 작성 위치는 문제가 되지 않는다.
	...
	// 유지와 관련된 코드 -> DB서버를 반드시 경유해야함 -> 서블릿을 직접호출X 
	// xxx.kh -> board2Controller (x)
	//	  	  -> ActionServlet (o)
	// xxx.jsp -> HttpServlet
	// 자바스크립트는 이용할 수 없다 ↓
...
<script type="text/javascript">
	...
	// 전역변수 - javascript에서는 선언만 하고 선택을 하지 않았거나 값이 할당되지 않으면
	// 그냥 null 비교만 해서는 안된다.
