...
public class BoardLogic {
	...
	// Logic에서는 그대로 모두 사용함 - RequestParam이나 RequestMapping, Model 모두 필요없음
	...
	// 하나의 메소드 안에서 DAO의 여러 메서드를 호출할 수 있음 - 트랜잭션처리 공통된 관심사를 갖는 부분
	...
	public int boardInsert(Map<String, Object> pMap) {
		...
		result = boardDao.boardMInsert(pMap); //  새글 쓰기, 댓글쓰기 동시
	...
	public List<Map<String, Object>> boardDetail(Map<String, Object> pMap) {
		...
		List<Map<String, Object>> boardList = null;
		boardList = boardDao.boardMList(pMap);
