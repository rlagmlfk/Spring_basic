...
// html+javascript 혼합 처리(권장-리액트)
	...
	function deleteForm(){
		// 리액트 계속 - import(ES6, module, ES6기준 문법-안전, require-CommonJS)
		$("#dlg_boardDel").dialog({
			title:'글삭제- 비번확인',
	...
	function boardDel(){
		console.log('boardDelete 호출 성공')
		// 자바스크립트에서는 값에 더블 혹은 싱글 쿼테이션 안붙이면 변수
		let db_pw = "<%=rb_pw%>";
...
<body>
    ...
    <div id="dlg_boardUpd" footer="#tb_boardUpd" class="easyui-dialog" title="수정하기" data-options="modal:true,closed:true" style="width:600px;height:400px;padding:10px">
        <!-- 바이너리(문자열+숫자) 파일 전송할 때는 반드시 post방식 처리 첨부파일 처리시 -->
